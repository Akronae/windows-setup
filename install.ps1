...
choco install -y googlechrome firefox brave vscode notepad2 cygwin qbittorrent powertoys slack discord sharex mongodb-compass parsec vlc bulk-crap-uninstaller 7zip ffmpeg
